    ...
    <section class="section breadcrumb-section">
        <div class="w-layout-blockcontainer container w-container">
            <div class="breadcrumb-info-block">
                ...
                <a href="#" class="breadcrumb-link">Melioratsiya maruzalari</a></div>
        </div>
    </section>
                        ...
                        <div role="listitem" class="blog-collection-item w-dyn-item">
                            <div class="blog-single-main-block">
                                <a id="w-node-_12a34fd4-70dc-e61d-9cde-bbb0997ddb46-39340b82" href="#" style="border: 1px solid black" class="blog-image-link w-inline-block">
                                    <img alt="image" loading="lazy" src="img/lectures/{{ $item->lecture_photo }}" sizes="(max-width: 479px) 94vw, (max-width: 767px) 40vw, (max-width: 991px) 41vw, (max-width: 1439px) 20vw, 276.421875px" srcset="img/lectures/{{ $item->lecture_photo }} 500w, img/lectures/{{ $item->lecture_photo }} 800w, img/lectures/{{ $item->lecture_photo }} 1080w, img/lectures/{{ $item->lecture_photo }} 1400w" class="blog-image">
                                </a>
                                <div id="w-node-_12a34fd4-70dc-e61d-9cde-bbb0997ddb48-39340b82" class="blog-info">
                                    <a href="books/{{ $item->lecture_file }}" class="blog-title-link w-inline-block">
                                        <h3 class="blog-single-title">{{ $item->lecture_name }}</h3>
                                    </a>
                                </div>
                            </div>
                        </div>
