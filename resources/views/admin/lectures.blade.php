...
@section('lectures') active @endsection
            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        @foreach($lectures as $id => $item)
                            <tr>
                                <td>{{ $item->lecture_name }}</td>
                                <td> {{ $item->lecture_type }}</td>
                                <td class="w-15"><img src="../img/articles/{{ $item->lecture_photo }}" alt="" class="img-fluid"></td>
                                <td>
                ...
                <div class="">
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            <form action="{{ route('admin.add.lecture') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="book_types" required name="book_types" class="form-control">
