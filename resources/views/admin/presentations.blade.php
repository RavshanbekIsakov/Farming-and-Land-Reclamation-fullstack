...
@section('presentations') active @endsection
            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        @foreach($presentations as $id => $item)
                            <tr>
                                <td>{{ $item->pres_name }}</td>
                                <td class="w-15"><img src="../img/presentations/{{ $item->pres_photo }}" alt="" class="w-50"></td>
                                <td>
                                <td>{{ $item->pres_type }}</td>
                                <td>
                                    <form action="{{ route('admin.delete.pres') }}" method="post">
                                        @csrf
                                        @method('delete')
                ...
                <div class="">
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            <form action="{{ route('admin.add.pres') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Prezentatsiya fayl nomi <span class="text-danger">*</span></label>
                                    <input name="name" required type="text" class="form-control" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Prezentatsiya PDF Fayli <span class="text-danger">*</span></label>
                                    <input name="file" required type="file" class="form-control" placeholder="" accept="application/pdf">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Prezentatsiya muqova rasmi <span class="text-danger">*</span></label>
                                    <input name="image" required type="file" class="form-control" placeholder="" accept="image/*">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Fayl turi<span class="text-danger">*</span></label>
                                    <select id="pres_type" required name="pres_type" class="form-control">
...
@section('js')
    <script>
        ...
        notyf.success({
            message: 'Prezentatsiya qo\'shildi',
            duration: 10000,
            dismissible: true,
            position: {
                x: 'right',
        ...
        notyf.warning({
            message: 'Prezentatsiya o\'chirildi!',
            duration: 10000,
            dismissible: true,
            position: {
                x: 'right',
